...
app = modal.App("esrgan-api-4x")  # 4x upscaling version
...
def get_gcs_credentials():
    ...
    # Modal injects the secret as an environment variable
...
@app.function(
    ...
    secrets=[modal.Secret.from_name("gcs-credentials")]  # Load secret
)
@modal.asgi_app()
def web():
    return fastapi_app
